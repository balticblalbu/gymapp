...
class TokenStore(context: Context) {
    ...
    /** Custom order of the (unfiltered) workout history, comma separated workout ids. */
    var historyOrder: String
        get() = prefs.getString(KEY_HISTORY_ORDER, "") ?: ""
        set(value) = prefs.edit().putString(KEY_HISTORY_ORDER, value).apply()
